...
      // 💡 NEW: Map the state messages to the Gemini API format for conversation history
      const chatHistory = messages
        .filter(msg => msg.id !== 'typing') // Filter out the temporary typing indicator
        .map(msg => ({
...
      // Send the entire chat history in the payload
